$(function () {
    $('#submit').click(function () {
        ...
        var properties = [
            ...
            { type: 'candidate_birthyear', string: $('#candidate-birthyear').val() },
            { type: 'candidate_phone', string: $('#candidate-phone').val() },
            { type: 'candidate_email', string: $('#candidate-email').val() },
            { type: 'candidate_workplace', string: $('#candidate-workplace').val() },
            { type: 'applicant_name', string: $('#applicant-name').val() },
            { type: 'applicant_email', string: $('#applicant-email').val() },
            { type: 'applicant_workplace', string: $('#applicant-workplace').val() },
